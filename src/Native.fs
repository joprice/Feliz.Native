...
type Native =
    ...
    static member inline view(x: #seq<ReactElement>) =
        Feliz.Interop.reactApi.createElement (
            ...
            (createObj [ "children" ==> Feliz.Interop.reactApi.Children.toArray (Array.ofSeq x) ])
        )
...
module Dimensions =
    ...
    let useWindowDimensions: unit -> DimensionsInfo =
        import "useWindowDimensions" "react-native"
...
module PermissionsAndroid =
    ...
    let PermissionsAndroid: IPermissionsAndroid =
