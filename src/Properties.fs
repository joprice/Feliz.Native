...
[<Erase>]
type IImageProp = interface end

[<Erase>]
type IAnimatedImageProperties = interface end

[<Erase>]
type IImageBackgroundProp = interface end

[<Erase>]
type IKeyboardAvoidingViewProp = interface end

[<Erase>]
type ISafeAreaViewProp = interface end

[<Erase>]
type IScrollViewProp = interface end

[<Erase>]
type IAnimatedScrollViewProperties = interface end

[<Erase>]
type ITextProp = interface end

[<Erase>]
type IAnimatedTextProperties = interface end

[<Erase>]
type ITextInputProp = interface end

[<Erase>]
type ITouchableHighlightProp = interface end

[<Erase>]
type ITouchableOpacityProp = interface end

[<Erase>]
type IPressableProp = interface end

[<Erase>]
type IActivityIndicatorProp = interface end

[<Erase>]
type ISwitchProp = interface end
...
type style =
    ...
    static member inline borderTopRightRadius(x: int) : IStyleAttribute =
        Interop.mkStyle "borderTopRightRadius" x

    static member inline borderBottomLeftRadius(x: int) : IStyleAttribute =
        Interop.mkStyle "borderBottomLeftRadius" x

    static member inline borderBottomRightRadius(x: int) : IStyleAttribute =
        Interop.mkStyle "borderBottomRightRadius" x
    ...
    static member inline shadowOffset(x: {| width: int; height: int |}) : IStyleAttribute =
...
module Types =
    ...
    type LayoutEvent = { layout: Layout; target: int }
...
type image =
    ...
    static member inline progressiveRenderingEnabled(x: bool) : IImageProp =
        unbox ("progressiveRenderingEnabled", x)
    ...
    static member inline defaultSource(x: string) : IImageProp =
        unbox ("defaultSource", image.localImage x)
...
type imageBackground =
    ...
    static member inline defaultSource(x: string) : IImageBackgroundProp =
        unbox ("defaultSource", image.localImage x)
    ...
    static member inline imageStyle(x: seq<Feliz.IStyleAttribute>) : IImageBackgroundProp =
        unbox ("imageStyle", keyValueList CaseRules.LowerFirst x)
...
type keyboardAvoidingView =
    ...
    static member inline keyboardVerticalOffset(x: float) : IKeyboardAvoidingViewProp =
        unbox ("keyboardVerticalOffset", x)

    static member inline keyboardVerticalOffset(x: int) : IKeyboardAvoidingViewProp =
        unbox ("keyboardVerticalOffset", x)
...
type safeAreaView =
    ...
    static member inline emulateUnlessSupported(value: bool) : ISafeAreaViewProp =
        unbox ("emulateUnlessSupported", value)
...
type scrollView =
    ...
    static member inline automaticallyAdjustContentInsets(x: bool) : IScrollViewProp =
        unbox ("automaticallyAdjustContentInsets", x)

    static member inline automaticallyAdjustKeyboardInsets(x: bool) : IScrollViewProp =
        unbox ("automaticallyAdjustKeyboardInsets", x)

    static member inline automaticallyAdjustsScrollIndicatorInsets(x: bool) : IScrollViewProp =
        unbox ("automaticallyAdjustsScrollIndicatorInsets", x)
    ...
    static member inline disableScrollViewPanResponder(x: bool) : IScrollViewProp =
        unbox ("disableScrollViewPanResponder", x)
    ...
    static member inline showsHorizontalScrollIndicator(x: bool) : IScrollViewProp =
        unbox ("showsHorizontalScrollIndicator", x)

    static member inline showsVerticalScrollIndicator(x: bool) : IScrollViewProp =
        unbox ("showsVerticalScrollIndicator", x)
...
type TextProps<'a> =
    inherit Prop<'a>
    static member inline accessibilityHint(x: string) : 'a = unbox ("accessibilityHint", x)
    static member inline accessibilityLabel(x: string) : 'a = unbox ("accessibilityLabel", x)
    static member inline accessible(x: bool) : 'a = unbox ("accessible", x)
    static member inline adjustsFontSizeToFit(x: bool) : 'a = unbox ("adjustsFontSizeToFit", x)
    static member inline allowFontScaling(x: bool) : 'a = unbox ("allowFontScaling", x)
    static member inline ellipsizeMode(x: string) : 'a = unbox ("ellipsizeMode", x)
    static member inline maxFontSizeMultiplier(x: int) : 'a = unbox ("maxFontSizeMultiplier", x)
    static member inline maxFontSizeMultiplier(x: float) : 'a = unbox ("maxFontSizeMultiplier", x)
    static member inline minFontSizeMultiplier(x: int) : 'a = unbox ("minFontSizeMultiplier", x)
    static member inline minFontSizeMultiplier(x: float) : 'a = unbox ("minFontSizeMultiplier", x)
    static member inline nativeId(x: string) : 'a = unbox ("nativeID", x)
    static member inline numberOfLines(x: int) : 'a = unbox ("numberOfLines", x)
    static member inline onLayout(x: Types.LayoutEvent -> unit) : 'a = unbox ("onLayout", x)
    static member inline onLongPress(x: Types.PressEvent -> unit) : 'a = unbox ("onLongPress", x)

    static member inline onMoveShouldSetResponder(x: Types.PressEvent -> unit) : 'a =
        unbox ("onMoveShouldSetResponder", x)

    static member inline onPress(x: Types.PressEvent -> unit) : 'a = unbox ("onPress", x)
    static member inline onPressIn(x: Types.PressEvent -> unit) : 'a = unbox ("onPressIn", x)
    static member inline onPressOut(x: Types.PressEvent -> unit) : 'a = unbox ("onPressOut", x)
    static member inline onResponderGrant(x: Types.PressEvent -> unit) : 'a = unbox ("onResponderGrant", x)
    static member inline onResponderGrant(x: obj -> unit) : 'a = unbox ("onResponderGrant", x)
    static member inline onResponderMove(x: Types.PressEvent -> unit) : 'a = unbox ("onResponderMove", x)
    static member inline selectable(x: bool) : 'a = unbox ("selectable", x)
    static member inline testID(x: string) : 'a = unbox ("testID", x)
    static member inline text(x: string) : 'a = unbox ("children", unbox (x))
    static member inline text(x: int) : 'a = unbox ("children", unbox (string x))
    static member inline userSelect(x: string) : 'a = unbox ("userSelect", x)

[<Erase>]
[<AbstractClass>]
type text =
    inherit TextProps<ITextProp>

[<Erase>]
[<AbstractClass>]
type animatedText =
    inherit TextProps<IAnimatedTextProperties>
...
type ViewProps<'a> =
    ...
    static member inline accessibilityElementsHidden(x: bool) : 'a =
        unbox ("accessibilityElementsHidden", x)

    static member inline accessibilityHint(x: string) : 'a = unbox ("accessibilityHint", x)
    static member inline accessibilityLanguage(x: string) : 'a = unbox ("accessibilityLanguage", x)

    static member inline accessibilityIgnoresInvertColors(x: bool) : 'a =
        unbox ("accessibilityIgnoresInvertColors", x)

    static member inline accessibilityLabel(x: string) : 'a = unbox ("accessibilityLabel", x)
    static member inline accessible(x: bool) : 'a = unbox ("accessible", x)
    static member inline ariaBusy(x: bool) : 'a = unbox ("aria-busy", x)
    static member inline ariaChecked(x: bool) : 'a = unbox ("aria-checked", x)
    static member inline ariaDisabled(x: bool) : 'a = unbox ("aria-disabled", x)
    static member inline ariaLabel(x: string) : 'a = unbox ("aria-label", x)
    static member inline ariaLabelledBy(x: string) : 'a = unbox ("aria-labelledby", x)
    static member inline nativeID(x: string) : 'a = unbox ("nativeID", x)

    static member inline needsOffscreenAlphaCompositing(x: string) : 'a =
        unbox ("needsOffscreenAlphaCompositing", x)

    static member inline onAccessibilityAction(x: obj -> unit) : 'a = unbox ("onAccessibilityAction", x)
    static member inline onAccessibilityTap(x: obj -> unit) : 'a = unbox ("onAccessibilityTap", x)
    static member inline onLayout(x: obj -> unit) : 'a = unbox ("onLayout", x)
    static member inline onLayout(x: Types.LayoutEvent -> unit) : 'a = unbox ("onLayout", x)

    static member inline onMoveShouldSetResponder(x: Types.PressEvent -> bool) : 'a =
        unbox ("onMoveShouldSetResponder", x)

    static member inline onMoveShouldSetResponder(x: obj -> bool) : 'a = unbox ("onMoveShouldSetResponder", x)

    static member inline onMoveShouldSetResponderCapture(x: Types.PressEvent -> bool) : 'a =
        unbox ("onMoveShouldSetResponderCapture", x)

    static member inline onMoveShouldSetResponderCapture(x: obj -> bool) : 'a =
        unbox ("onMoveShouldSetResponderCapture", x)

    static member inline onResponderGrant(x: Types.PressEvent -> unit) : 'a = unbox ("onResponderGrant", x)
    static member inline onResponderGrant(x: obj -> unit) : 'a = unbox ("onResponderGrant", x)
    static member inline onResponderMove(x: Types.PressEvent -> unit) : 'a = unbox ("onResponderMove", x)
    static member inline onResponderReject(x: Types.PressEvent -> unit) : 'a = unbox ("onResponderReject", x)
    static member inline onResponderRelease(x: Types.PressEvent -> unit) : 'a = unbox ("onResponderRelease", x)

    static member inline onResponderTerminate(x: Types.PressEvent -> unit) : 'a = unbox ("onResponderTerminate", x)

    static member inline onResponderTerminationRequest(x: Types.PressEvent -> unit) : 'a =
        unbox ("onResponderTerminationRequest", x)

    static member inline onStartShouldSetResponder(x: Types.PressEvent -> bool) : 'a =
        unbox ("onStartShouldSetResponder", x)

    static member inline onStartShouldSetResponderCapture(x: Types.PressEvent -> bool) : 'a =
        unbox ("onStartShouldSetResponderCapture", x)

    static member inline removeClippedSubviews(x: bool) : 'a = unbox ("removeClippedSubviews", x)
    static member inline testID(x: string) : 'a = unbox ("testID", x)
    static member inline source(value: {| uri: string |}) : 'a = unbox ("source", value)

[<Erase>]
[<AbstractClass>]
type view =
    inherit ViewProps<IViewProp>

[<Erase>]
[<AbstractClass>]
type animatedView =
    inherit ViewProps<IAnimatedViewProperties>
